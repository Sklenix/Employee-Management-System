...
class InjuriesDatatableController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $injury = new Injury();
        $injury->injury_description = $request->injury_note_add;
        $injury->injury_date = $request->injury_date_add;
        $injury->employee_id = $request->employee_id_add;
        $injury->shift_id = $request->shift_id_add;
        $injury->save();
    ...
    public function update(Request $request, $id){
        ...
        $smenaUdaje = Injury::getEmployeeInjuries($user->company_id,$data->employee_id,$data->shift_id);
        $injury_date = new DateTime($request->injury_date);
        $puvodniInjuryDate = new DateTime($data->injury_date);
        $shift_start = new DateTime($smenaUdaje[0]->shift_start);
        $shift_end = new DateTime($smenaUdaje[0]->shift_end);
        ...
        if(($diffValidDatum == 0) && ($request->injury_description == $data->injury_description)){
            $bool = 0;
        }else{
            $bool = 1;
        }

        $data->injury_date = $request->injury_date;
        $data->injury_description = $request->injury_description;
        $data->save();
    ...
    public function destroy($id){
        $data = Injury::findOrFail($id)->delete();
