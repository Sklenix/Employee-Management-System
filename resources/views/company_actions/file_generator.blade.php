...
@section('content')
    <section class="page-section"  id="generator" style="padding-top:40px;padding-bottom: 60px;background-color: #F5F5F5" >
        <div class="fluid-container" style="margin-left: 20px;margin-right: 20px;padding-bottom: 750px;">
            <div class="row">
                    <br>
                ...
                <a class="btn btn-dark" href="{{route('generator.employeesList')}}" style="cursor: pointer;color:black;text-decoration: none;margin-right: 25px;margin-bottom:5px;">
                ...
                <a class="btn btn-primary" href="{{route('generator.shiftsList')}}" style="cursor: pointer;color:black;text-decoration: none;margin-right: 25px;margin-bottom:5px;">
                    <div class="col-lg-1 col-md-1 text-center">
                            <div style="padding-top: 50px;padding-bottom:50px;">
                ...
                <a class="btn btn-primary" href="{{route('generator.companyProfile')}}" style="cursor: pointer;color:black;text-decoration: none;margin-right: 25px;margin-bottom:5px;">
                    <div class="col-lg-1 col-md-1 text-center">
                            <div style="padding-top: 50px;padding-bottom:50px;">
                ...
                <a class="btn btn-dark" href="{{route('generator.generateEmployeesRatings')}}" style="cursor: pointer;color:black;text-decoration: none;margin-right: 25px;margin-bottom:5px;">
                    <div class="col-lg-1 col-md-1 text-center">
                        <div style="padding-top: 50px;padding-bottom:50px;">
                ...
                <div class="col-lg-2 col-md-2 text-center" style="margin-top:5px;">
                    <form id="aktualniSmeny" method="GET" action="{{route('generator.generateEmployeeCurrentShifts')}}">
                        ...
                        <a class="btn btn-dark" onclick="document.getElementById('aktualniSmeny').submit();" style="cursor: pointer;color:black;text-decoration: none;">
                            <div style="padding-top: 50px;padding-bottom:50px;">
                ...
                <div class="col-lg-2 col-md-2 text-center" style="margin-top:5px;">
                    <form id="smenyZamestnance" method="GET" action="{{route('generator.generateEmployeeShifts')}}">
                        ...
                        <a class="btn btn-dark" onclick="document.getElementById('smenyZamestnance').submit();" style="cursor: pointer;color:black;text-decoration: none;">
                            <div style="padding-top: 50px;padding-bottom:50px;">
                ...
                <div class="col-lg-2 col-md-2 text-center" style="margin-top:5px;">
                    <form id="zamestnanciSmena" method="GET" action="{{route('generator.generateShiftEmployees')}}">
                        ...
                        <a class="btn btn-dark" onclick="document.getElementById('zamestnanciSmena').submit();" style="cursor: pointer;color:black;text-decoration: none;">
                            <div style="padding-top: 50px;padding-bottom:50px;">
